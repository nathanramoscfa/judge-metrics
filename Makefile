...
# identical. Later steps add: seed, compute-metrics, bootstrap.
.PHONY: install test lint fmt fmt-check typecheck check gate kit up down migrate dev-api dev-web ingest-fjc
