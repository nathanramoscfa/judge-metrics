...
Timelines.** Not started. Phase 1 (Foundation, Canonical Schema, and
...
squash-merged commit. Phase 2 begins in a fresh conversation after the
planning kit is re-exported (`uv run poe kit`) and
`docs/phase02-roadmap.md` is authored from
[`ROADMAP.md`](../ROADMAP.md) §4 Phase 2.
