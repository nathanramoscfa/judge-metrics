...
[`ROADMAP.md`](../ROADMAP.md) §4 Phase 2 on 2026-09-16; Phase 2 Step 1
(the deterministic synthetic generator, branch
`feature/phase02-step1-synthetic-generator`) begins in a fresh
conversation.
